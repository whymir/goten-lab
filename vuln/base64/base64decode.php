                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <h3 class="lh-1">Base64 Decode</h3>
                      </div>
                    </div>
              ...
              <div class="col-lg-8">
                <div class="card card-lg">
                  <div class="card-body">
                    <div class="markdown">
                      <div>
                        <h3 class="lh-1">Base64 Decoder</h3>
                      </div>
                      <div class="row g-2 align-items-center">
                        <form role="form">
                          <div class="mb-3">
                            <h4 class="lh-1">Encoded Data:</h4>
                            <textarea class="form-control" id="inputData" rows="6" oninput="decodeData()"></textarea>
                          </div>
                        </form>
                        <div class="mt-3">
                          <h4 class="lh-1">Decoded Data:</h4>
                          <textarea class="form-control" id="decodedData" rows="6" readonly></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
