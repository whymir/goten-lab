                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled space-y-1">
                      ...
                      <li><b>Why this happen</b> : If secure token is generated, the implementation reuses the token for the entire session and does not enforce token rotation or one-time use, leaving room for exploitation if the token is obtained.</li>
