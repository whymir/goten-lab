                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled space-y-1">
                      ...
                      <li><b>Why this happen</b> : The vulnerability exists due to the insecure method of token generation. Using time-based predictable tokens means attackers can guess or brute-force valid tokens, thereby bypassing the CSRF protection.</li>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/csrfhighcode.txt');
              ?>
            </div>
