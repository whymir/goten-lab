              ...
              <div class="col-lg-12">
                <div class="card card-lg">
                  <div class="card-body" style="background-color: #E5E4E2;">
                      ...
                      <hr>
                      <h3>Low Security Source Code <a href="csrflow.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/csrflowcode.txt');
                        ?>
                      </pre>
                      <br>
                      <h3>Medium Security Source Code <a href="csrfmedium.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                      ...
                      <br>
                      <h3>High Security Source Code <a href="csrfhigh.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
