                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <h3 class="lh-1">Json Web Token</h3>
                      </div>
                    </div>
                    <ul class="list-unstyled space-y-1">
                      <li><b>Level</b> : Others</li>
                      <li><b>Short Form</b> : Json Web Token</li>
                      <li><b>Injection Point</b> : JWT Password Signature</li>
              ...
              <div class="col-lg-8">
                <div class="card card-lg">
                  <div class="card-body">
                    <div class="markdown">
                      <div>
                        <h3 class="lh-1">Get Flag</h3>
                      </div>

                      <div class="row g-2 align-items-center">
                          
                        <button class="btn btn-primary" id="sendRequestBtn"> Show Me The Flag </button>
                        <br>
                        <br>
                        <center>
                          <pre><?php if(isset($data)){echo $data;}?></pre>
                        </center>
                      </div>
                    </div>
                  </div>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Json Web Token - Source Code</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/jwtcode.txt');
              ?>
            </div>
    ...
    document.getElementById('sendRequestBtn').addEventListener('click', function() {
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                form.action = './api/process-token.php';
                form.method = 'post';
