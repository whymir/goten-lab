                        ...
                        <div class="markdown">
                          ...
                          <div class="row g-2 align-items-center">
                            <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                              <a href="<?php echo basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));?>?page=page1" class="btn btn-primary w-100">
                                Page 1
                              </a>
                            </div>
                            <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                              <a href="<?php echo basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));?>?page=page2" class="btn btn-secondary w-100">
                                Page 2
                              </a>
                            </div>
                            <div class="col-6 col-sm-4 col-md-2 col-xl py-3">
                              <a href="<?php echo basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH));?>?page=page3" class="btn btn-success w-100">
                                Page 3
                              </a>
                            </div>
                        </div>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled space-y-1">
                      ...
                      <li><b>Injection Point</b> : $_GET['page']</li>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/localfileinclusionphpappendcode.txt');
              ?>
            </div>
