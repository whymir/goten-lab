                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled space-y-1">
                      ...
                      <li><b>Injection Point</b> : Auth Token </li>
                      <li><b>Why this happen</b> : User role is stored directly in a cookie and trusted without validation.</li>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/cookielowcode.txt');
              ?>
            </div>
