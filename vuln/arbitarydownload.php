                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <h3 class="lh-1">Arbitary Download</h3>
                      </div>
                    </div>
              ...
              <div class="col-lg-8">
                <div class="card card-lg">
                  <div class="card-body">
                        <div class="markdown">
                          <div>
                            <h3 class="lh-1">Download File</h3>
                          </div>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Arbitary Download - Source Code</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/arbitarydownload.txt');
              ?>
            </div>
