              ...
              <div class="col-lg-12">
                <div class="card card-lg">
                  <div class="card-body" style="background-color: #E5E4E2;">
                      ...
                      <h1>Cross Site Scripting - Dome</h1>
                      <hr>
                      <h3>Low Security Source Code <a href="xssdomlow.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      ...
                      <br>
                      <h3>Medium Security Source Code <a href="xssdommedium.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                      ...
                      <br>
                      <h3>High Security Source Code <a href="xssdomhigh.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                      ...
                      <br>
                      <h3>Impossible Security Source Code <a href="xssdomimpossible.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
