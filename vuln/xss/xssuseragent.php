                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <h3 class="lh-1">Cross Site Scripting</h3>
                      </div>
                    </div>
                    <ul class="list-unstyled space-y-1">
                      <li><b>Level</b> : Others</li>
                      <li><b>Short Form</b> : XSS</b></li>
                      <li><b>Injection Point</b> : HTTP Header (user-agent)</li>
              ...
              <div class="col-lg-8">
                <div class="card card-lg">
                  <div class="card-body">
                    <div class="markdown">
                      <div>
                        <h3 class="lh-1">Your User Agent</h3>
                      </div>
                      <center>
                      <br>
                      <p>
                      ...
                      if(isset($_COOKIE['user_id'])){
                        echo "<code style='color:red;'>" . htmlentities($_SERVER['HTTP_USER_AGENT']) . "</code><br>";
