...
<html lang="en">
  ...
  <body >
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <h3 class="lh-1">Message Digest Algorithm 5</h3>
                      </div>
                    </div>
                    <ul class="list-unstyled space-y-1">
                      <li><b>Type</b> : Hash function, one-way-function</b></li>
                      <li><b>Short Form</b> : MD5</b></li>
                      <li><b>Use case</b> : MD5 checksums are commonly used to verify the integrity of files transferred over the internet.In storage systems, MD5 hashes are sometimes used to identify duplicate files or data blocks.</li>
              ...
              <div class="col-lg-8">
                <div class="card card-lg">
                  <div class="card-body">
                    <div class="markdown">
                      <div>
                        <h3 class="lh-1">MD5 Hash Generator</h3>
                      </div>
                      <div class="row g-2 align-items-center">
                        <form role="form">
                          <div class="mb-3">
                            <h3 class="lh-1">String Text:</h3>
                            <textarea class="form-control" id="inputText" rows="6" oninput="generateMD5()"></textarea>
                          </div>
                        </form>
                        <div class="mt-3">
                          <h3 class="lh-1">MD5 Hashing:</h3>
                          <textarea class="form-control" id="md5Hash" rows="6" readonly></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    function generateMD5() {
      ...
      // Generate MD5 hash
      var md5Hash = CryptoJS.MD5(inputText).toString();
