                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <h3 class="lh-1">SQL Injection</h3>
                      </div>
                    </div>
                    <ul class="list-unstyled space-y-1">
                      <li><b>Level</b> : Others</b></li>
                      <li><b>Short Form</b> : SQLI</b></li>
                      <li><b>Injection Point</b> : User Agent Header</b></li>
              ...
              <div class="col-lg-8">
                <div class="card card-lg">
                  <div class="card-body">
                        <div class="markdown">
                          <div>
                            <h3 class="lh-1">Shows User ID</h3>
                          </div>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
                <?php
                highlight_file('./sourcecode/sqlinjectioncookiecode.txt');
                ?>
            </div>
      ...
      <div class="modal modal-blur fade" id="modal-payloads" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
              <a href="./payloads/low_sqli_manual_payload.txt" type="button" class="btn btn-primary" download>Download</a>
            </div>
          </div>
        </div>
      </div>
