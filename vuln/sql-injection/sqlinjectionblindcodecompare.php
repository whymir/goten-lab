              ...
              <div class="col-lg-12">
                <div class="card card-lg">
                  <div class="card-body" style="background-color: #E5E4E2;">
                      ...
                      <hr>
                      <h3>Low Security Source Code <a href="sqlinjectionblindlow.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/sqlinjectionblindlowcode.txt');
                        ?>
                      </pre>
                      <br>
                      <h3>Medium Security Source Code <a href="sqlinjectionblindmedium.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/sqlinjectionblindmediumcode.txt');
                        ?>
                      </pre>
                      <br>
                      <h3>High Security Source Code <a href="sqlinjectionblindhigh.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/sqlinjectionblindhighcode.txt');
                        ?>
                      </pre>
                      <br>
                      <h3>Impossible Security Source Code <a href="sqlinjectionblindimpossible.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
