              ...
              <div class="col-lg-12">
                <div class="card card-lg">
                  <div class="card-body" style="background-color: #E5E4E2;">
                      ...
                      <h1>SQL Injection</h1>
                      <hr>
                      <h3>Low Security Source Code <a href="sqlinjectionlow.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/sqlinjectionlowcode.txt');
                        ?>
                      </pre>
                      <br>
                      <h3>Medium Security Source Code <a href="sqlinjectionmedium.php" class="btn btn-primary float-end">Go to level</a>
                      </h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/sqlinjectionmediumcode.txt');
                        ?>
                      </pre>
                      <br>
                      <h3>High Security Source Code  <a href="sqlinjectionhigh.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/sqlinjectionhighcode.txt');
                        ?>
                      </pre>
                      <br>
                      <h3>Impossible Security Source Code  <a href="sqlinjectionimpossible.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file('./sourcecode/sqlinjectionimpossiblecode.txt');
                        ?>
                      </pre>
                    </div>
                  </div>
