              ...
              <div class="col-lg-8">
                <div class="card card-lg">
                  <div class="card-body">
                        ...
                        if (isset($_GET['input'])) {
                            // Injection Point: User's input is used to replace the template placeholder.
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled space-y-1">
                      ...
                      <li><b>Injection Point</b> : ?input= </li>
                      <li><b>Why this happen</b> : The vulnerability exists because the code naively filters part of the input but then directly evaluates user-supplied input. This allows an attacker to bypass the weak filter and inject PHP code.</li>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/sstimediumcode.txt');
              ?>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
              <a href="ssticodecompare.php" type="button" class="btn btn-primary">Compare All Level</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal modal-blur fade" id="modal-payloads" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./payloads/ssti_all_payload.txt');
              ?>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
              <a href="./payloads/ssti_all_payload.txt" type="button" class="btn btn-primary" download>Download</a>
            </div>
          </div>
        </div>
      </div>
