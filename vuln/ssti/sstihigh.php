                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled space-y-1">
                      ...
                      <li><b>Injection Point</b> : User input </li>
                      <li><b>Why this happen</b> : The vulnerability arises due to the absence of secure templating practices. The system blindly replaces template placeholders with user data and writes it to a PHP file that is later included, allowing for PHP code injection.</li>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/sstihighcode.txt');
              ?>
            </div>
