                ...
                <div class="card card-lg">
                  <div class="card-body">
                        ...
                        if (isset($_GET['name'])) {
                            ...
                            $name = $_GET['name'];
                            // This is intentionally vulnerable. The eval will run anything supplied by the user.
                            eval("\$output = \"$name\";");
                            echo $output;
                        } 
                        else {
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled space-y-1">
                      ...
                      <li><b>Injection Point</b> : ?name= </li>
                      <li><b>Why this happen</b> : The application directly evaluates user-supplied input via <i>eval()</i> without proper sanitization, allowing attackers to inject PHP code.</li>
        ...
        <div class="modal-dialog modal-full-width modal-dialog-centered modal-dialog-scrollable" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="background-color: #E5E4E2;">
              <?php
              highlight_file('./sourcecode/sstilowcode.txt');
              ?>
            </div>
