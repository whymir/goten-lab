              ...
              <div class="col-lg-12">
                <div class="card card-lg">
                  <div class="card-body" style="background-color: #E5E4E2;">
                      ...
                      <hr>
                      <h3>Low Security Source Code <a href="sstilow.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      ...
                      <br>
                      <h3>Medium Security Source Code <a href="sstimedium.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                      ...
                      <br>
                      <h3>High Security Source Code <a href="sstihigh.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
