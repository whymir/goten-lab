                ...
                <div class="col-12 col-md-3 border-end">
                  <div class="card-body">
                    ...
                    <div class="list-group list-group-transparent">
                      <a href="./settings.php" class="list-group-item list-group-item-action d-flex align-items-center active">Uploads Folder</a>
      ...
      <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <div class="w-100">
              <div class="row">
                <div class="col"><a href="./settings.php" class="btn w-100">
                    Close
                  </a></div>
              </div>
            </div>
