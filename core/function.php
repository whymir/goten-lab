...
class Pages
{
	function errorpage($data)
	{
		...
		echo '<head>';
		echo '<link rel="icon" sizes="16x16" href="./static/goten-cyber-lab.jpeg">';
		echo '<title>' . $title . '</title>';
		echo '</head>';
		echo '<body style="background:#F6FFFE;">';
		echo '<table width="100%" height="100%">';
		echo '<tr>';
		echo '<td align="center" valign="middle"><img border="0" width="120" height="120" src="./static/goten-cyber-lab.jpeg"><br/><br/><!-- '.$data.' --></br</td>';
		echo '</tr>';
		echo '</table>';
		echo '</body>';
