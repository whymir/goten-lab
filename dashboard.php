...
<!doctype html>
<!--
* GOTEN-CYBER-LAB - Vulnerable by design to learn common web vulnerability
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="./static/goten-cyber-lab.jpeg" type="image/png">
    <!-- CSS files -->
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(./static/goten-cyber-lab.jpeg)"></span>
                  ...
                  <div class="card-body">
                    <div class="markdown">
                      <div>
                        ...
                        <h3 class="lh-1">Welcome to GOTEN-CYBER-LAB!</h3>
                      </div>
                      <p>GOTEN-CYBER-LAB is a deliberately vulnerable web application crafted to assist security professionals in refining their skills and evaluating their tools in a lawful setting. It also contributes to advancing web developers' comprehension of securing web applications. Moreover, GOTEN-CYBER-LAB facilitates both students and instructors in comprehending web application security within a supervised environment.</p>
                      <p>The goal of GOTEN-CYBER-LAB is to provide a platform for practicing numerous common web vulnerabilities, offering varying levels of difficulty, all presented within a simple and user-friendly interface.</p>
